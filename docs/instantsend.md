...
This mechanism has been integrated into Bitcore-Node-Addmore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/addmore/insight-api-addmore#web-socket-api](https://github.com/addmore/insight-api-addmore#web-socket-api)
* API: [https://github.com/addmore/insight-api-addmore#instantsend-transactions](https://github.com/addmore/insight-api-addmore#instantsend-transactions)
...
By default, the Addmore Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Addmore Core daemon:
