...
Only requiring some minor changes is addmore.cpp.
...
Changes to addmore.cpp
----------------------
addmore.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
