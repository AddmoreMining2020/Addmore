...
#define BOOST_TEST_MODULE Addmore Test Suite

#include "test_addmore.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_addmore_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
