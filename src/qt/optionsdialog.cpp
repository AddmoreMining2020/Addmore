    ...
    mapper(0)
{
    ...
    // ui->theme->addItem(QString("Addmore-light-hires"), QVariant("light-hires"));
    // ui->theme->addItem(QString("Addmore-blue"), QVariant("drkblue"));
    // ui->theme->addItem(QString("Addmore-Crownium"), QVariant("crownium"));
    // ui->theme->addItem(QString("Addmore-traditional"), QVariant("trad"));
    ...
    Q_FOREACH(const QString &langStr, translations.entryList())
    {
        ...
        if(langStr.contains("_"))
        {
            ...
            ui->lang->addItem(locale.nativeLanguageName(), QVariant(langStr));
#else
            /** display language strings as "language - country (locale name)", e.g. "German - Germany (de)" */
            ui->lang->addItem(QLocale::languageToString(locale.language()), QVariant(langStr));
#endif
        }
        else
        {
