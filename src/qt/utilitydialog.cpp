    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Addmore Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Addmore Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  addmore-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Addmore in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ADD, 0.1 ADD, 1 ADD and 10 ADD -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Addmore Core is shutting down...") + "<br /><br />" +
