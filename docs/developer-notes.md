...
Addmore Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9898.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9899 for connections and services them.
...
However, in open source software such as Addmore Core, where everyone uses
...
pay attention to for reviewers of Addmore Core code.

General Addmore Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Addmore Core uses tinyformat, which is type safe. Leave them out to avoid confusion
