/* src/config/addmore-config.h.  Generated from addmore-config.h.in by configure.  */
/* src/config/addmore-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ADDMORE_CONFIG_H

#define ADDMORE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/addmore/addmore/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Addmore Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Addmore Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "addmore"
