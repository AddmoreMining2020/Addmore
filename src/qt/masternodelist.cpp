    ...
    walletModel(0)
{
    ...
    ui->tableWidgetMyMasternodes->setStyleSheet("QTableView { background-color: transparent; border: 0px solid #fff; } QTableView::item { background-color: transparent; border-bottom: 1px solid #1a8cff; }");
    ...
    ui->tableWidgetMasternodes->setStyleSheet("QTableView { background-color: transparent; border: 0px solid #fff; } QTableView::item { background-color: transparent;  border-bottom: 1px solid #1a8cff; }");
