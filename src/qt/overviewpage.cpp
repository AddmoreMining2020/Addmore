...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitcoinUnits::ADD),
    ...
    timer(nullptr)
{
    ...
    ui->labelWalletStatus->setStyleSheet("QLabel { color: #fe5c5c; }");
    ui->labelPrivateSendSyncStatus->setText("(" + tr("out of sync") + ")");
    ui->labelPrivateSendSyncStatus->setStyleSheet("QLabel { color: #fff; margin-right: 3px; }");
    ui->labelTransactionsStatus->setText("(" + tr("out of sync") + ")");
    ui->labelTransactionsStatus->setStyleSheet("QLabel { color: #fe5c5c; }");
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("ADD")
        updateDisplayUnit();
