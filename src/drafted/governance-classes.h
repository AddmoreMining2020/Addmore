 ...
 *
 *   // network
 *   CAddmoreNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.addmore.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAddmoreNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAddmoreNetwork(UniValue objIn)
    {
...
// // can be under: AddmoreNetwork
// //   -- signature requirements : Key1(User)
// class CAddmoreNetworkVariable : public CGovernanceObject
// {
// private:
