...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AddmoreNetwork") type = AddmoreNetwork;
    if(strType == "AddmoreNetworkVariable") type = AddmoreNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AddmoreNetwork) s = "AddmoreNetwork";
    if(type == AddmoreNetworkVariable) s = "AddmoreNetworkVariable";
